...
/** Helper: check if CV has expected field with type check 5 */
export function hasTupleField5(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 6 */
export function hasTupleField6(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 7 */
export function hasTupleField7(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 8 */
export function hasTupleField8(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 9 */
export function hasTupleField9(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 10 */
export function hasTupleField10(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 11 */
export function hasTupleField11(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 12 */
export function hasTupleField12(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 13 */
export function hasTupleField13(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 14 */
export function hasTupleField14(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
/** Helper: check if CV has expected field with type check 15 */
export function hasTupleField15(cv: ClarityValue, field: string): boolean {
  return isTupleCV(cv) && field in cv.data;
}
