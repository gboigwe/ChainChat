...
/** CV builder convenience for arg position 12 */
export function arg12<T extends ClarityValue>(cv: T): T { return cv; }
/** CV builder convenience for arg position 13 */
export function arg13<T extends ClarityValue>(cv: T): T { return cv; }
/** CV builder convenience for arg position 14 */
export function arg14<T extends ClarityValue>(cv: T): T { return cv; }
/** CV builder convenience for arg position 15 */
export function arg15<T extends ClarityValue>(cv: T): T { return cv; }
/** CV builder convenience for arg position 16 */
export function arg16<T extends ClarityValue>(cv: T): T { return cv; }
/** CV builder convenience for arg position 17 */
export function arg17<T extends ClarityValue>(cv: T): T { return cv; }
/** CV builder convenience for arg position 18 */
export function arg18<T extends ClarityValue>(cv: T): T { return cv; }
/** CV builder convenience for arg position 19 */
export function arg19<T extends ClarityValue>(cv: T): T { return cv; }
/** CV builder convenience for arg position 20 */
export function arg20<T extends ClarityValue>(cv: T): T { return cv; }
